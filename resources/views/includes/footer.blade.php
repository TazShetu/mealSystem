        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li>Provide a valid email address at edit profile menu to recover forgotten password.</li>
                    <li>Member can enter/edit/delete data but it will not be added into calculation until meal-manager accepts that.</li>
                    <li>If meal-manager enter new data for the same date and same member will auto overwrite the old data.</li>
                    ...
                    <li>Name and date in table can not be edited. So if you want to change those better delete and enter again.</li>
