        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul>
                    ...
                    <li>If meal-manager enters new data for the same date and same member, it will auto overwrite the old data.</li>
                    ...
                    <li>Calculation result may vary from user to user by (+/-)1 Tk</li>
                </ul>
            </div>
